      ...
      <div class="multimedia-title">MULTIMEDIA</div>
         <div class="multimedia-wrapper">
            <div class="multimedia-trailer">
                ...
                <a href="#" id="trailer-btn1"><i class="far fa-play-circle fa-5x"></i></a>
            </div>
            <div class="multimedia-trailer">
                <img src="img/trailer-img-2.jpg" alt="預告">
                <a href="#" id="trailer-btn2"><i class="far fa-play-circle fa-5x"></i></a>
            </div>
         </div>

         <div class="multimedia-wrapper">
            <div class="multimedia-trailer">
                <img src="img/trailer-img-3.jpg" alt="預告">
                <a href="#" id="trailer-btn3"><i class="far fa-play-circle fa-5x"></i></a>
            </div>
            <div class="multimedia-trailer">
                <img src="img/trailer-img-4.jpg" alt="預告">
                <a href="#" id="trailer-btn4"><i class="far fa-play-circle fa-5x"></i></a>
            </div>
         </div>

         <div class="multimedia-wrapper">
            <div class="multimedia-trailer">
                <img src="img/trailer-img-5.jpg" alt="預告">
                <a href="#" id="trailer-btn5"><i class="far fa-play-circle fa-5x"></i></a>
            </div>
            <div class="multimedia-trailer">
                <img src="img/trailer-img-6.jpg" alt="預告">
                <a href="#" id="trailer-btn6"><i class="far fa-play-circle fa-5x"></i></a>
            </div>
         </div>
     </div>
